// import { RootState, Size, useFrame, useThree, Viewport } from '@react-three/fiber';
...
//   const [{ dpr }, size, gl] = useThree<[Viewport, Size, THREE.WebGLRenderer]>((s) => [s.viewport, s.size, s.gl]);
